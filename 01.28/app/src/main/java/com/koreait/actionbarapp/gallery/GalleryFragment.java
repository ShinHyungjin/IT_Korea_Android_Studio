...
public class GalleryFragment extends androidx.fragment.app.Fragment {
    ...
    public void getList(){
        Thread thread = new Thread(){
            public void run() {
                ...
                try {
                    URL url=new URL("http://192.168.35.161:7777/gallery");
                    ...
                    try {
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            load(filename,title); //이미지 한개를 서버로 부터 가져온후, 어댑터의 리스트에 추가!!
                        }
    ...
    public void load(String image, String title){
        Thread thread = new Thread(){
            public void run() {
                try {
                    URL url = new URL("http://192.168.35.161:7777/images/"+image);
    ...
    public void getListByAsync(){
        ...
        myAsync.execute("http://192.168.35.161:7777/gallery");
